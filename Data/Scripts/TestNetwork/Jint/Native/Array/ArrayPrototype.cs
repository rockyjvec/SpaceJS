    ...
    public sealed class ArrayPrototype : ArrayInstance
    {
        ...
        private JsValue Reduce(JsValue thisObj, JsValue[] arguments)
        {
            ...
            else
            {
                ...
                {
                    JsValue temp;
                    if (kPresent = o.TryGetValue((uint) k, out temp))
                    {
                        accumulator = temp;
                    }
        ...
        private JsValue Some(JsValue thisObj, JsValue[] arguments)
        {
            ...
            uint o1;
            JsValue o2;
            return target.FindWithCallback(arguments, out o1, out o2);
        }
        ...
        private JsValue Find(JsValue thisObj, JsValue[] arguments)
        {
            ...
            JsValue value;
            uint o1;
            target.FindWithCallback(arguments, out o1, out value);
            return value;
        }
        ...
        private JsValue FindIndex(JsValue thisObj, JsValue[] arguments)
        {
            ...
            uint index;
            JsValue o2;
            if (target.FindWithCallback(arguments, out index, out o2))
            {
                return index;
            }
            return -1;
        ...
        public class ISortComparer : IComparer<JsValue>
        {
            ...
            int IComparer<JsValue>.Compare(JsValue x, JsValue y)
            {
        ...
        private string StringFromJsValue(JsValue value)
        {
        ...
        private JsValue Concat(JsValue thisObj, JsValue[] arguments)
        {
            ...
            for (var i = 0; i < items.Count; i++)
            {
                ...
                if (e is ArrayInstance)
                {
                    ...
                    {
                        JsValue subElement;
                        if (eArray.TryGetValue(k, out subElement))
                        {
        ...
        {
            if (thisObject is ArrayInstance)
            {
                var arrayInstance = thisObject as ArrayInstance;
        ...
        internal abstract class ArrayOperations
        {
            ...
            {
                if (instance is ArrayInstance)
                {
                    var arrayInstance = instance as ArrayInstance;
