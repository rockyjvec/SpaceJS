...
namespace Jint.Native.String
{
    ...
    {
        private static readonly StringExecutionContext _executionContext = new StringExecutionContext();
        ...
        public static StringExecutionContext Current => _executionContext;
    }
}