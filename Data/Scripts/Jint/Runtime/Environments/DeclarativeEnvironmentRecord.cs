...
namespace Jint.Runtime.Environments
{
    ...
    public sealed class DeclarativeEnvironmentRecord : EnvironmentRecord
    {
        ...
        private void SetItem(string key, Binding value)
        {
            if (_set && _key != key)
            {
                if (_dictionary == null)
        ...
        private Binding GetExistingItem(string key)
        {
            if (_set && _key == key)
            {
                return _value;
            ...
            return _dictionary.GetItem(key);
        }
        ...
        {
            var binding = GetExistingItem(name);
        ...
        {
            Binding binding = GetExistingItem(name);
